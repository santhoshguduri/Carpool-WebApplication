...
import { IRideBooking } from "../../Components/BookRide/BookRide";
import { Dispatch } from "redux";

export const CreateRideBooking =(rideBooking : IRideBooking) => {
    return function(){
...
export const searchAvailableRides =(startPoint : string, destination : string, seats : Number, rideBookingDate : Date, time : string) => {
...
export const setBookingStatus =(bookingId : Number ,status : Number) => {
    return function(){
