...
class MatchedUser extends Component<IProps>{
    ...
    render(){
        return(
            <div className="userCard">
                ...
                <div className="route">
                        <i className="fas fa left-point fa-circle"></i>
                        <i className="fas fa center fa-circle"></i>
                        <i className="fas fa center fa-circle"></i>
                        <i className="fas fa center fa-circle"></i>
                        <i className="fas fa center fa-circle"></i>
                        <i className="fas fa right-point fa-map-marker"></i>
                        </div>
                </div>
        )
    }
