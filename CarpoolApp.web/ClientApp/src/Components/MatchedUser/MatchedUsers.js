...
import user from '../NavigationBar/user.jfif';
    ...
    render(){
        return(
            <div className="userCard">
                ...
                <h5>Date</h5>
                <p>{this.props.ride.rideDate}</p>
                <h5>Price</h5>
                <p>Rs.{this.props.ride.price}</p>
                </div>
                ...
                <h5>Time</h5>
                <p>{this.props.ride.rideTime}</p>
                <h5>Seat Availability</h5>
                <p>{this.props.ride.seatsAvailable}</p>
                </div>
                <div className="route">
