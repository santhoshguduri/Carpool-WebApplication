...
class NavBar extends Component{
    ...
    render(){
        var data:IUserData ={name:'',userId:0,token:''};
        ...
        return(
            <div id="NavBar">
                ...
                {(data !=null || data != undefined) && data.token!=''? (
                <div id="userDetails">
                    <h2>{data.name}</h2>
                    <span className="dropdown">
                    <img className=" dropdown-toggle" id="img-button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" src={user} alt="user" />
